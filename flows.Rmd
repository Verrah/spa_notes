...
In this note, we will use data from the city of San Francisco representing bike trips on their public bike share system. The source is the SF Open Data portal ([link](http://www.bayareabikeshare.com/open-data)) and the dataset comprises trips (station of origin to station of destination) undertaken in the system from September 2015 to August 2016.

* Read stations
* Read flows (create all potential ones?)
* Read routes and explain
* Calculate distances (euclidean + routes)
